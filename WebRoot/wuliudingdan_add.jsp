...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addWuliudingdan.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">添加物流订单</td>
						</tr>
		...
		<tr ><td width="200">单价：</td><td><input name='danjia' type='text' id='danjia' value='5' onblur='checkform()' class="form-control" />&nbsp;*<label id='clabeldanjia' style='margin-top:16px;' /></td></tr>
...
<script language=javascript >  
 ...
 function checkform(){  
	...
	var zhongliangobj = document.getElementById("zhongliang"); if(zhongliangobj.value!=""){ if(/^[0-9]+.?[0-9]*$/.test(zhongliangobj.value)){document.getElementById("clabelzhongliang").innerHTML=""; }else{document.getElementById("clabelzhongliang").innerHTML="&nbsp;&nbsp;<font color=red>必需数字型</font>"; return false;}}  

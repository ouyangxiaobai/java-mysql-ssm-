...
<dl class="custom">
			...
			<dd><a href="doUpdateShangjiaxinxi2.do" target="hsgmain">修改个人资料</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">商品管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="shangpinxinxi_add.jsp" target="hsgmain">商品添加</a></dd>
<dd><a href="shangpinxinxiList2.do" target="hsgmain">商品查询</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">下单管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="xiadanxinxiList2.do" target="hsgmain">下单查询</a></dd>
...
<dd><a href="waimaipeisongList2.do" target="hsgmain">外卖配送查询</a></dd>

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <td>${u.pingyu}</td>
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateWuliuqudanlb.do?id=${u.id }">评价</a>   <a class="btn btn-info btn-small" href="wuliuqudanDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>

...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">物流取单列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="wuliuqudanList.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.wuliubianhao}</td>    <td>${u.wupinmingcheng}</td>    <td>${u.wupinleixing}</td>    <td>${u.danjia}</td>    <td>${u.zhongliang}</td>    <td>${u.zongjia}</td>    <td>${u.qujiandizhi}</td>    <td>${u.shoujianren}</td>    <td>${u.dianhua}</td>    <td>${u.dizhi}</td>    <td>${u.xiadanren}</td>    <td>${u.zhuangtai}</td>    <td>${u.gonghao}</td>    <td>${u.xingming}</td>    <td>${u.lianxidianhua}</td>    <td>${u.pingjia}</td>    <td>${u.pingyu}</td>    
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateWuliuqudan.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteWuliuqudan.do?id=${u.id }"
		 ...
		 <c:if test="${page.page>1}">
              <a href="wuliuqudanList.do?page=1" >首页</a>
             <a href="wuliuqudanList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="wuliuqudanList.do?page=${page.page+1 }">下一页</a>
			<a href="wuliuqudanList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>

...
<dl class="custom">
			...
			<dd><a href="doUpdatePeisongxinxi2.do" target="hsgmain">修改个人资料</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">外卖配送管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="waimaipeisongList4.do" target="hsgmain">外卖配送查询</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">物流取单管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="wuliudingdan_yanben3.do" target="hsgmain">物流取单添加</a></dd>
<dd><a href="wuliuqudanList3.do" target="hsgmain">物流取单查询</a></dd>

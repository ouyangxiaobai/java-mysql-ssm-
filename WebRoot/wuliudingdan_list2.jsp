...
<html xmlns="http://www.w3.org/1999/xhtml">
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="wuliudingdanList2.do" name="myform" method="post">
    ...
    <td  width='80' align='center' bgcolor='#ebf0f7'>是否已配送</td>
    ...
    <td align='center'>${u.issh} </td>
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateWuliudingdan.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteWuliudingdan.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="wuliudingdanDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="wuliudingdanList2.do?page=1" >首页</a>
             <a href="wuliudingdanList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="wuliudingdanList2.do?page=${page.page+1 }">下一页</a>
			<a href="wuliudingdanList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>

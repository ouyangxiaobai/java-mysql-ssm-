	...
	<body>
			<form action="updateWuliuqudan.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<tr style='display:none'><td width="200">物流编号：</td><td><input name='wuliubianhao' type='text' id='wuliubianhao' value='' onblur='' class="form-control"  readonly='readonly' /></td></tr>
		<tr style='display:none'><td width="200">物品名称：</td><td><input name='wupinmingcheng' type='text' id='wupinmingcheng' value='' onblur='' class="form-control"  readonly='readonly' /></td></tr>
		<tr style='display:none'><td width="200">物品类型：</td><td><input name='wupinleixing' type='text' id='wupinleixing' value='' onblur='' class="form-control"  readonly='readonly' /></td></tr>
		<tr style='display:none'><td width="200">单价：</td><td><input name='danjia' type='text' id='danjia' value='' onblur='' class="form-control"  readonly='readonly' /></td></tr>
		<tr style='display:none'><td width="200">重量：</td><td><input name='zhongliang' type='text' id='zhongliang' value='' onblur='' class="form-control"  readonly='readonly' /></td></tr>
		<tr style='display:none'><td width="200">总价：</td><td><input name='zongjia' type='text' id='zongjia' value='' onblur='' class="form-control"  readonly='readonly' /></td></tr>

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <td>${u.xiadanren}</td>
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href='waimaipeisong_add.jsp?id=${u.id}'>添加配送</a> <a class="btn btn-info btn-small" href="xiadanxinxiDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>

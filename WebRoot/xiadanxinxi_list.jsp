				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">下单信息列表</td>
						</tr>
					</table>
				</td>
			</tr>
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.shangpinbianhao}</td>    <td>${u.shangpinmingcheng}</td>    <td>${u.shangpinleibie}</td>    <td>${u.jiage}</td>    <td>${u.shoumairen}</td>    <td>${u.qujiandizhi}</td>    <td>${u.shoujianren}</td>    <td>${u.dianhua}</td>    <td>${u.dizhi}</td>    <td>${u.xiadanren}</td>    
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateXiadanxinxi.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteXiadanxinxi.do?id=${u.id }"

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <td align='center'>${u.issh} </td>
                              ...
                              <td align="center"> <a class="btn btn-info btn-small" href='wuliuqudan_add.jsp?id=${u.id}'>取单</a> <a class="btn btn-info btn-small" href="wuliudingdanDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>

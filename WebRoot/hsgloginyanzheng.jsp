...
<html>
 ...
 if(cx.equals("配送")){sql="select * from peisongxinxi where gonghao='"+uid+"' and mima='"+pwd+"'";}if(cx.equals("商家")){sql="select * from shangjiaxinxi where zhanghao='"+uid+"' and mima='"+pwd+"' and issh='是'";}if(cx.equals("注册用户")){sql="select * from yonghuzhuce where yonghuming='"+uid+"' and mima='"+pwd+"' and issh='是'";}

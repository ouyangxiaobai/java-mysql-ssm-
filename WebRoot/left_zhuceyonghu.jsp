...
<dl class="custom">
			<dt onClick="changeImage()">下单管理<img src="images/left/select_xl01.png"></dt>
			
<dd><a href="xiadanxinxiList3.do" target="hsgmain">下单查询</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">外卖配送管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="waimaipeisongList3.do" target="hsgmain">外卖配送查询</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">物流订单管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="wuliudingdan_add.jsp" target="hsgmain">物流订单添加</a></dd>
<dd><a href="wuliudingdanList2.do" target="hsgmain">物流订单查询</a></dd>

		</dl>
<dl class="custom">
			<dt onClick="changeImage()">物流取单管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="wuliuqudanList2.do" target="hsgmain">物流取单查询</a></dd>

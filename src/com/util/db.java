...
public class db {
	...
	// private String sConnStr = "jdbc:microsoft:sqlserver://localhost:1433;databasename=ssmtcpsxthsg7676X1B4"; 
	 
	 private String dbDriver="com.mysql.jdbc.Driver";
	 private String sConnStr = "jdbc:mysql://localhost:3306/ssmtcpsxthsg7676x1b4?useUnicode=true&amp;amp;amp;amp;amp;characterEncoding=utf-8"; 
	
	 // private String dbDriver="net.sourceforge.jtds.jdbc.Driver";
	// private String sConnStr = "jdbc:jtds:sqlserver://127.0.0.1:1433;databaseName=ssmtcpsxthsg7676X1B4"; 
	  ...
	  public List getShouyebht(){
		...
		public String readzd(String ntable,String nzd,String tjzd,String tjz){
			...
			try{
				...
				{
					String dir = rs.getString("content");
					if(i==0){
						result=dir;
					}
					i++;

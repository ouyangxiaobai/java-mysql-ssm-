...
public class Waimaipeisong {
    ...
    }	public String getQujiandizhi() {
        return qujiandizhi;
    }
    public void setQujiandizhi(String qujiandizhi) {
        this.qujiandizhi = qujiandizhi == null ? null : qujiandizhi.trim();
    ...
    public void setPeisongren(String peisongren) {
        this.peisongren = peisongren == null ? null : peisongren.trim();
